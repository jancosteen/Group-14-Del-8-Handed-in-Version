...
{
    public abstract class MDR_AngularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MDR_AngularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MDR_AngularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MDR_AngularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MDR_AngularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MDR_AngularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MDR_AngularDbContext, Task<T>> func)
        {
            T result;
